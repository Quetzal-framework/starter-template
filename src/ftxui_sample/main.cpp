...
// configuration step. It creates a namespace called `starter_template`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", starter_template::cmake::project_name, starter_template::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", starter_template::cmake::project_version);
      return EXIT_SUCCESS;
    }
